This is a [Vite](https://vitejs.dev) template bootstrapped with [`@farcaster/create-mini-app`](https://github.com/farcasterxyz/miniapps/tree/main/packages/create-mini-app) for [Vibes.Engineering](https://vibes.engineering).
